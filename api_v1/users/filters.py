...
class CandidateFilter(django_filters.FilterSet):
    vacancy = django_filters.NumberFilter(field_name="vacancy__title")
    position = django_filters.CharFilter(field_name="vacancy__department__position__name_ru", lookup_expr="icontains")
